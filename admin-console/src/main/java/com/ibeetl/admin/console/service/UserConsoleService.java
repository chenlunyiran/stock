...
public class UserConsoleService extends BaseService<CoreUser> {
	...
	public void saveUser(CoreUser user) {
		...
		user.setCode(user.getCode().replace(" ", ""));
		...
		user.setPassword(passwordEncryptService.password(user.getCode()));
	 ...
	 * @param password
	 */
	public int resetPassword(Long id, String password, String password2) {
